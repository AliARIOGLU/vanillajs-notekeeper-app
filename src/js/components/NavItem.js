...
/*
    Creates a nav item representing a notebook. this item displays the notebooks name, allow editing and deletion of the notebook
    and handles click events to display its associated notes.
*/
...
export const NavItem = function (id, name) {
  ...
  /*
    Handles the click event on the nav item. Updates the note panel's title, retrieves the associated notes, 
    and marks the item as active.
  */

  navItem.addEventListener("click", function () {
    notePanelTitle.textContent = name;
    activeNotebook.call(this); // this: navItem
